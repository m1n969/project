...
# 画不同数据
plt.errorbar(x, y1,  yerr=yerr1,fmt='o-', linewidth=10, markersize=36, color='black', label='Vd 0.3V (1mA range)')  # 互换
#plt.errorbar(x, y2, yerr=yerr2,fmt='s-', linewidth=6, markersize=30, color='black', label='Vd 0.5V (1mA range)')  # 互换
